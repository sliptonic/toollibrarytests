    ...
    def highlightBlock(self, text):
        ...
        for pattern, format in self.highlightingRules:
            ...
            while index >= 0:
                ...
                # Get the length of how long the expression is true, set the
                # format from the start to the length with the text format
        ...
        # A THIRD " SHOULD NOT CAUSE THE WORDS INBETWEEN SECOND AND THIRD TO BE
        # COLORED
...
class WndTutorial06(base, form):
    ...
    def __init__(self, parent=None):
        ...
        QtCore.QObject.connect(self.uiFilter, QtCore.SIGNAL(
        ...
        QtCore.QObject.connect(self.uiTree.selectionModel(), QtCore.SIGNAL(
            "currentChanged(QModelIndex, QModelIndex)"), self._propEditor.setSelection)
        QtCore.QObject.connect(self._model, QtCore.SIGNAL(
            "dataChanged(QModelIndex, QModelIndex)"), self.updateXml)
